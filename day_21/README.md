...
This problem focuses on Expression parsing. [Detailed problem description will be added here based on the specific algorithmic challenge.]
...
[Description of the optimal approach using Expression parsing]
...
1. **Expression parsing** - [Key insight about the main concept]
...
**Next**: Proceed to [Day 22: Next Problem](../day_22/) to continue learning!

**Previous**: Return to [Day 20: Previous Problem](../day_20/) or [Course Schedule](../course_schedule.md).

---
*💡 Key Pattern: Expression parsing - This pattern appears frequently in algorithmic problems!*