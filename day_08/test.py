"""
Test cases for Day 8: Find Anagrams

Comprehensive test suite for Find Anagrams with
...
class TestFindAnagrams:
    """Test class for Find Anagrams solutions."""
...
def visual_test():
    ...
    print("\n" + "="*60)
    print("VISUAL DEMONSTRATION: FIND ANAGRAMS")
    print("="*60)
    
    print("This section will show step-by-step execution")
    print("Key concepts demonstrated: Pattern matching")
...
def educational_demo():
    ...
    print("\n" + "="*60)
    print("EDUCATIONAL DEMO: PATTERN MATCHING")
    print("="*60)
    
    print("Key concepts for this problem:")
    print(f"• Pattern matching")
    print(f"• Problem type: String Matching")
...
def run_all_tests():
    ...
    print("🧪 TESTING FIND ANAGRAMS")
    print("="*60)
    
    test_instance = TestFindAnagrams()
