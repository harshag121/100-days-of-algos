"""
Day 66: Shortest Path in Grid
Topic: BFS in Graphs
Difficulty: Medium

Problem: Implement solution for Shortest Path in Grid using Breadth-first search.
...
def solution_brute_force(data):
    """
    Brute force approach for Shortest Path in Grid.
...
def main_solution(data):
    """
    Main solution function for Shortest Path in Grid.
...
def demonstrate_solution(data):
    ...
    """
    print(f"Solving Shortest Path in Grid with input: {data}")
...
if __name__ == "__main__":
    # Test cases for Shortest Path in Grid
    test_cases = [
    ...
    print("Testing Shortest Path in Grid Solutions...")
    print("=" * 60)
