"""
Day 81: Search in Rotated Array
Topic: Search Variations
Difficulty: Medium

Problem: Implement solution for Search in Rotated Array using Modified binary search.
...
def solution_brute_force(data):
    """
    Brute force approach for Search in Rotated Array.
...
def solution_optimized(data):
    ...
    This is the preferred implementation demonstrating Modified binary search.
    """
...
def main_solution(data):
    """
    Main solution function for Search in Rotated Array.
    
    This implements the optimal approach using Modified binary search.
    ...
    # Use the concepts: Modified binary search
    pass
...
def demonstrate_solution(data):
    ...
    """
    print(f"Solving Search in Rotated Array with input: {data}")
    print("Key concepts: Modified binary search")
    print("Steps:")
...
if __name__ == "__main__":
    ...
    print("Testing Search in Rotated Array Solutions...")
    print("=" * 60)
    ...
    print("\n🎯 Key Concept: Modified binary search")
