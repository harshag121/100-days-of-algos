"""
Day 85: Sort by Custom Criteria
Topic: Custom Sorting
Difficulty: Medium

Problem: Implement solution for Sort by Custom Criteria using Comparator functions.
...
def solution_brute_force(data):
    """
    Brute force approach for Sort by Custom Criteria.
...
def solution_optimized(data):
    """
    Optimized approach using Comparator functions.
    
    Time Complexity: O(?)
    Space Complexity: O(?)
    
    This is the preferred implementation demonstrating Comparator functions.
    """
...
def main_solution(data):
    """
    Main solution function for Sort by Custom Criteria.
    
    This implements the optimal approach using Comparator functions.
    ...
    # Use the concepts: Comparator functions
    pass
...
def demonstrate_solution(data):
    ...
    """
    print(f"Solving Sort by Custom Criteria with input: {data}")
    print("Key concepts: Comparator functions")
    print("Steps:")
...
if __name__ == "__main__":
    # Test cases for Sort by Custom Criteria
    test_cases = [
    ...
    print("Testing Sort by Custom Criteria Solutions...")
    print("=" * 60)
    ...
    print("\n🎯 Key Concept: Comparator functions")
