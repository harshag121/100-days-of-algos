...
Problem: Implement solution for Longest Common Subsequence using String algorithms.
...
def main_solution(data):
    """
    Main solution function for Longest Common Subsequence.
...
def demonstrate_solution(data):
    ...
    """
    print(f"Solving Longest Common Subsequence with input: {data}")
