...
Problem: Implement solution for Kth Largest Element using Heap data structure.
...
def solution_brute_force(data):
    """
    Brute force approach for Kth Largest Element.
...
def main_solution(data):
    """
    Main solution function for Kth Largest Element.
...
def demonstrate_solution(data):
    ...
    """
    print(f"Solving Kth Largest Element with input: {data}")
...
if __name__ == "__main__":
    # Test cases for Kth Largest Element
    test_cases = [
