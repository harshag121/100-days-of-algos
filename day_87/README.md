...
This problem focuses on Selection algorithms. [Detailed problem description will be added here based on the specific algorithmic challenge.]
...
[Description of the optimal approach using Selection algorithms]
...
1. **Selection algorithms** - [Key insight about the main concept]
...
**Next**: Proceed to [Day 88: Next Problem](../day_88/) to continue learning!

**Previous**: Return to [Day 86: Previous Problem](../day_86/) or [Course Schedule](../course_schedule.md).

---
*💡 Key Pattern: Selection algorithms - This pattern appears frequently in algorithmic problems!*