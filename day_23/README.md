...
This problem focuses on Double-ended queue. [Detailed problem description will be added here based on the specific algorithmic challenge.]
...
[Description of the optimal approach using Double-ended queue]
...
1. **Double-ended queue** - [Key insight about the main concept]
...
**Next**: Proceed to [Day 24: Next Problem](../day_24/) to continue learning!

**Previous**: Return to [Day 22: Previous Problem](../day_22/) or [Course Schedule](../course_schedule.md).

---
*💡 Key Pattern: Double-ended queue - This pattern appears frequently in algorithmic problems!*