...
Problem: Implement solution for House Robber using Linear DP.
...
def solution_brute_force(data):
    """
    Brute force approach for House Robber.
...
def solution_optimized(data):
    """
    Optimized approach using Linear DP.
    
    Time Complexity: O(?)
    Space Complexity: O(?)
    
    This is the preferred implementation demonstrating Linear DP.
    """
...
def main_solution(data):
    """
    Main solution function for House Robber.
    
    This implements the optimal approach using Linear DP.
...
def demonstrate_solution(data):
    ...
    """
    print(f"Solving House Robber with input: {data}")
    print("Key concepts: Linear DP")
    print("Steps:")
