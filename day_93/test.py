"""
Test cases for Day 93: House Robber

Comprehensive test suite for House Robber with
...
class TestHouseRobber:
    """Test class for House Robber solutions."""
...
def visual_test():
    ...
    print("\n" + "="*60)
    print("VISUAL DEMONSTRATION: HOUSE ROBBER")
    print("="*60)
    
    print("This section will show step-by-step execution")
    print("Key concepts demonstrated: Linear DP")
...
def educational_demo():
    ...
    print("\n" + "="*60)
    print("EDUCATIONAL DEMO: LINEAR DP")
    print("="*60)
    
    print("Key concepts for this problem:")
    print(f"• Linear DP")
    print(f"• Problem type: 1D DP")
