...
Problem: Implement solution for Validate BST using BST properties.
...
def solution_brute_force(data):
    """
    Brute force approach for Validate BST.
...
def solution_optimized(data):
    ...
    This is the preferred implementation demonstrating BST properties.
    """
...
def main_solution(data):
    """
    Main solution function for Validate BST.
    
    This implements the optimal approach using BST properties.
    ...
    # Use the concepts: BST properties
    pass
...
def demonstrate_solution(data):
    ...
    """
    print(f"Solving Validate BST with input: {data}")
    print("Key concepts: BST properties")
    print("Steps:")
...
if __name__ == "__main__":
    ...
    print("Testing Validate BST Solutions...")
    print("=" * 60)
