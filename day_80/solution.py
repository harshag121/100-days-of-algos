...
Topic: Non-comparison Sorting
Difficulty: Medium

Problem: Implement solution for Counting Sort using Linear time sorting.
...
def solution_brute_force(data):
    """
    Brute force approach for Counting Sort.
...
def solution_optimized(data):
    """
    Optimized approach using Linear time sorting.
    
    Time Complexity: O(?)
    Space Complexity: O(?)
    
    This is the preferred implementation demonstrating Linear time sorting.
    """
...
def main_solution(data):
    """
    Main solution function for Counting Sort.
    
    This implements the optimal approach using Linear time sorting.
    ...
    # Use the concepts: Linear time sorting
    pass
...
def demonstrate_solution(data):
    ...
    """
    print(f"Solving Counting Sort with input: {data}")
    print("Key concepts: Linear time sorting")
    print("Steps:")
...
if __name__ == "__main__":
    ...
    print("Testing Counting Sort Solutions...")
    print("=" * 60)
    ...
    print("\n🎯 Key Concept: Linear time sorting")
